      ...
      <main>
        ...
        >
          <div style="margin-bottom: 1rem;">
            <label for="file" style="display: block; margin-bottom: 0.5rem;">Select file to upload:</label>
            <input 
              type="file" 
              id="file" 
              name="file" 
          ...
          <div style="margin-bottom: 1rem;">
            <label for="noteId" style="display: block; margin-bottom: 0.5rem;">Note ID (optional):</label>
            <input 
              type="text" 
              id="noteId" 
              name="noteId" 
